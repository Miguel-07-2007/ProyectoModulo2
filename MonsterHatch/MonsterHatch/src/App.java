public class App {
    public static void main(String[] args) throws Exception {
        /*
         * Cría una criatura enséñala y entrenala para actuar de diferentes maneras en una batalla
         ...
         */
         ...
         Criatura luminosa = new Criatura("luminosa", 100, 15, 10, new ComportamientoCurativo());
